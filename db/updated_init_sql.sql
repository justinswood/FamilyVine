-- Updated init.sql with marriage fields
-- Replace your existing backend/init.sql or db/init.sql with this:

-- Create members table with marriage fields
